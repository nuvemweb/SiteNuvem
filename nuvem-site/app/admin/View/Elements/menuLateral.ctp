<ul class='nav nav-stacked'>
    ...
    <li class='cursos' id="cursos">
        <?php
        echo $this->Html->link("<i class='icon-list'></i>Cursos", array("controller" => "Cursos",
            "action" => "index"), array("escape" => false));
        ?>
    </li>
    <li class='depoimentos' id="depoimentos">
        <?php
        echo $this->Html->link("<i class='icon-group'></i>Depoimentos", array("controller" => "Depoimentos",
            "action" => "index"), array("escape" => false));
        ?>
    </li>
